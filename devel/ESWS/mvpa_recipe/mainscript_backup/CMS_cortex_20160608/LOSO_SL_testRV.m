...
switch preallocate_SLrois
    case 'run'
        preprocessed_SLroi_files = preallocate_searchlight_rois(preproc_data_file_pointers,options);
        delete(gcp('nocreate'))
...
% parpool('AttachedFiles',{classifer_file})

brain_cells = LOSO_SL_mvpa(preprocessed_SLroi_files,preproc_data_file_pointers,options);
