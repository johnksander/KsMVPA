...
aname = 'ESWS_LOSO_perm_HPFU_MP';
num_workers = 4; %parpool workers

config_options.name = aname;
config_options.dataset = 'ESWS';%Del_MCQ/Aro_MCQ
config_options.rawdata_type = 'unsmoothed_raw'; % 'estimatedHDR_spm' | 'unsmoothed_raw' |'LSS_eHDR' | 'anatom'
...
predictions = LOSO_roi_parfor_perm_mvpa(preproc_data_file_pointers,options);
