...
options.which_behavior = 1; %only specify for complete_file behavioral measure
options.searchlight_radius = 1;

brain_cells = regmod_roi_searchlight(options);
