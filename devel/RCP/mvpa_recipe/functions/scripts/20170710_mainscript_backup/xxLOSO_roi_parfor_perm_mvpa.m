function predictions = xxLOSO_roi_parfor_perm_mvpa(subject_file_pointers,options)
        ...
        parfor permidx = 1:options.num_perms2test
            ...
            for testing_subject = 1:numel(options.subjects)
                if ismember(options.subjects(testing_subject),options.exclusions) == 1
                    ...
                    testing_labels = true_labels{testing_subject}; %give true label to testing subject
