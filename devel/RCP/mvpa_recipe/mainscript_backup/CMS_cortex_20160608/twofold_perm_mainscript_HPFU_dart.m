...
aname = 'ESWS_twofold_perm_HPFU_dart_comp_PCA_1knn';
num_workers = 3; %parpool workers
...
predictions = twofold_roi_parfor_perm_mvpa(preproc_data_file_pointers,options);
delete(gcp('nocreate'))
