...
clc
% 
% res_file = 'amyhipp_output.mat';
% res_folder = 'amyhipp_results_04142015';
% result_dir = '/home/ksander/MCQD_JohnK/mvpa_recipe/result_files';
% 
% 
% load(fullfile(result_dir,res_folder,res_file))

%load('minpool_nofs_LOSO_output.mat');
%clear minpool_LOSO_output
load('minpool_roi_output.mat');
clear minpool_roi_output

addpath(options.helper_function_dir)
addpath(fullfile(options.script_dir,'stat_functions'))

fname = 'minpool_roi'; %save fig name
%fname = 'within_subj'; %save fig name

%use script4getting stats to get options & paths !!
% 
