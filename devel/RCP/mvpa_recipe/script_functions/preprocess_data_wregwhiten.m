function preproc_data_file_pointers = preprocess_data_wregwhiten(options)
...
for idx = 1:numel(options.subjects),
    ...
    if ismember(options.subjects(idx),options.exclusions) == 0,
        ...
        behdata4regwhitening = collapse_behdata4regress_whiten(behavioral_data,options);
        ...
        for roi_idx = 1:numel(options.roi_list),
            ...
            data_matrix = regress_whiten(data_matrix,behdata4regwhitening,run_index,options); %whiten w/ regression
